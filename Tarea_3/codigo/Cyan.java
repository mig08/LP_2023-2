public class Cyan extends Pikinim{
    ...
    public Cyan(){
                   /*
    Funcion: constructor de cyan, es para crear objetos de clase cyan 
    ...
    */
    ...
    public void multiplicar(int cantidad){
                   /*
    Funcion: void multiplicar, funcion para aumentar la cantidad de pikinims usando cantidad * 3
